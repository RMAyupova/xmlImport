...
namespace XmlImport.Controllers
{
    public class HomeController : Controller
    {
        ...
        public string DownloadFile()
        {
            ...
            var urlPath = $"https://www.sec.gov/Archives/edgar/daily-index/{year}/{qtr}/";
            ...
            var pagestr = client.DownloadString(urlPath); //сетод возвращает htmlстраницу в стринг
            CreateDirectory(path);
                                                          //client.DownloadFile(url, fullpath);
            
            FileNameList = GetFileName(pagestr);// вызов метода кот вытаскивает имена файлов
            ...
            private List<string> GetFileName(string pagestr) 
            {
                ...
                foreach (string el in fullPagestr)
                {
                    ...
                    {
                         result.Add(el.Replace("a href=\"", " ").Replace("\">", " "));
                    }
